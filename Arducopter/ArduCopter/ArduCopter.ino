...
// Location & Navigation
////////////////////////////////////////////////////////////////////////////////
// This is the angle from the copter to the "" location in degrees * 100
...
// Used to track how many cm we are from the "" location
...
// The cm we are off in altitude from .alt â€“ Positive value means we are below the WP
...
// distance between plane and  in cm
...
// Counters for branching from 20 hz control loop
static byte fastmedium_loopCounter = 0;
...
//**************************************
    ...
    if(fastmedium_loopCounter == 5)
    {
      ...
      fastmedium_loopCounter=0;
    }
    fastmedium_loopCounter++;
}
