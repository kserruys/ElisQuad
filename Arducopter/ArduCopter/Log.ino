...
*/    
    // User added!!!!
//------------------------------------
    //DataFlash.WriteInt(correctionX);                         
    //DataFlash.WriteInt(correctionY);
    DataFlash.WriteLong(get_int(accel.x));
    DataFlash.WriteLong(get_int(accel.y));

//    DataFlash.WriteLong(get_int(STATE));
//    DataFlash.WriteLong(get_int(counterCorner));
//------------------------------------
...
*/    
    ...
    //int16_t temp1 = DataFlash.ReadInt();         // 7
    //int16_t temp2 = DataFlash.ReadInt();         // 8
    int32_t temp3 = DataFlash.ReadLong();         // 9
    int32_t temp4 = DataFlash.ReadLong();         // 10
    int32_t temp5 = DataFlash.ReadLong();         // 11
    int32_t temp6 = DataFlash.ReadLong();         // 12
    int32_t temp7 = DataFlash.ReadLong();         // 11
    int32_t temp8 = DataFlash.ReadLong();         // 12
    int32_t temp9 = DataFlash.ReadLong();         // 11
    int32_t temp10 = DataFlash.ReadLong();         // 12
//    int32_t temp11 = DataFlash.ReadLong();         // 11
//    int32_t temp12 = DataFlash.ReadLong();         // 12
    
    float ftemp3 = get_float(temp3);
    float ftemp4 = get_float(temp4);
    float ftemp5 = get_float(temp5);
    float ftemp6 = get_float(temp6);
    float ftemp7 = get_float(temp7);
    float ftemp8 = get_float(temp8);
    float ftemp9 = get_float(temp9);
    float ftemp10 = get_float(temp10);
//    float ftemp11 = get_float(temp11);
//    float ftemp12 = get_float(temp12);
    
    //cliSerial->print(temp1);
    //cliSerial->print_P(PSTR(", "));
    //cliSerial->print(temp2);
    //cliSerial->print_P(PSTR(", "));
    cliSerial->print(ftemp3);
    cliSerial->print_P(PSTR(", "));
    cliSerial->print(ftemp4);
    cliSerial->print_P(PSTR(", "));
    cliSerial->print(ftemp5);
    cliSerial->print_P(PSTR(", "));
    cliSerial->print(ftemp6);
    cliSerial->print_P(PSTR(", "));
    cliSerial->print(ftemp7);
    cliSerial->print_P(PSTR(", "));
    cliSerial->print(ftemp8);
    cliSerial->print_P(PSTR(", "));
    cliSerial->print(ftemp9);
    cliSerial->print_P(PSTR(", "));
    cliSerial->print(ftemp10);
//    cliSerial->print_P(PSTR(", "));
//    cliSerial->print(ftemp11);
//    cliSerial->print_P(PSTR(", "));
//    cliSerial->print(ftemp12);
    cliSerial->print_P(PSTR("\n"));
...
//// User added!!!!
////------------------------------------
//    DataFlash.WriteInt(correctionX);                        // 6
//    DataFlash.WriteInt(correctionY);                 	    // 7
//    DataFlash.WriteInt(newXError);                  	    // 8
//    DataFlash.WriteInt(newYError);                          // 9
////----------------------------
