...
class keyboardReader():
    ...
    def liftoffset(self):
        print "Input new liftoffThreshold"
        self.liftoffThreshold = self.stdin.readline().strip()
        self.line = self.liftoffThreshold + "||l"
